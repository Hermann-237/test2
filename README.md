...
For this advanced UI-Basics test, the students should complete the landing page of a computer shop. They must follow instructions in order to add elements, make the website responsive and change the format of the website. 
...
### Test rules
* The students should not receive help from classmates or teachers to complete the task. However, students can clarify the questions with the teacher (within reason). 
* Students can use google. 
* Copying answers from classmates without a solid understanding of the code will result in an automatic fail for the student. 
